...
std::vector<BenchmarkResults> run_all_impls(
    ...
    if (phase == Phase::CHOLESKY) {
        ...
        results.push_back(run_all_configs<TriblockTensor>(phase, solver, data, configs));
    } else if (phase == Phase::TRIBLOCK_TENSOR_GRAPH) {
        results.push_back(run_all_configs<TriblockTensorGraph>(phase, solver, data, configs));
    }
    return results;
}
...
int main(int argc, char **argv) {
    ...
    // run_all_impls(Phase::TRIBLOCK_TENSOR, Solver::CHOLESKY_TRIBLOCK, data_triblock, configs_triblock);
    // run_all_impls(Phase::TRIBLOCK_TENSOR_GRAPH, Solver::CHOLESKY_TRIBLOCK, data_triblock, configs_triblock);
    ...
    // run_all_impls(Phase::ENHANCED_DELUXE_PREMIUM_CHOLESKY, Solver::CHOLESKY_TRIBLOCK, data_triblock, configs_triblock);
